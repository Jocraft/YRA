...
PROJECT_APPS = [
    ...
    'learning_methods.apps.LearningMethodsConfig',
...
EMAIL_HOST_USER = config("EMAIL_HOST_USER", default="smtp.gmail.com")
EMAIL_HOST_PASSWORD = config("EMAIL_HOST_PASSWORD", default=587)
